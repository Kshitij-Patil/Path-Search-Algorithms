...
AStar::AStar(const Graph USGraph, const string source, const  string destination)
{
...
void AStar::ExecutePathSearchAlgorithm()
{
...
inline float AStar::EstimateHeuristic(string start, string end)
{
...
vector<string> AStar::ShiftMinCostElementToTop(map <vector<string>, float> estimated_cost_data_structure)
{
...
void AStar::RemoveDuplicatePaths()
{
